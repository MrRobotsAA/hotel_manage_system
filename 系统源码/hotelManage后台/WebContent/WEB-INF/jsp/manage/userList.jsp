  ...
  function click2(){
	  /* window.location.assign("http://www.w3school.com.cn");
	   window.location.href="www.baidu.com"; */
	     var v = document.getElementById("search_user").value;
	     var pp = "${ctx}"+"/manage_searchuserList.do?user_context="+v; 
	   // alert(pp);
...
<!--                            <a  href="添加用户.html" class="label label-warning" style="float:right; margin:8px;">添加</a> -->
                        ...
                        <div class="well brown">
                            <div class="well-content" style="border:0px;">
                               <input id="search_user" placeholder="请输入查询内容" value="请输入搜索内容" /> &nbsp;&nbsp;&nbsp;&nbsp;    
